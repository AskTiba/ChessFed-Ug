...
export const metadata: Metadata = {
  title: "National Rankings | ChessFed Uganda",
  description:
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-zinc-400 leading-relaxed max-w-2xl italic">
              Self-hosted from the official FIDE monthly rating list. Explore
              Uganda&apos;s strongest masters across Standard, Rapid, and Blitz.
            </p>
          </div>
        </div>
      </header>
        ...
        <div className="p-12 bg-blue-600 rounded-[3rem] text-white flex flex-col md:flex-row justify-between items-center gap-8 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-xl text-center md:text-left">
            ...
            <p className="text-blue-100 font-medium">
              The elite few qualify for the official National Team squad
              selection. Check your eligibility for the 2026 Chess Olympiad.
            </p>
          </div>
          <Link
            href="/national-team"
            className="relative z-10 px-8 py-4 bg-white text-blue-600 font-black rounded-2xl hover:scale-105 transition-all shadow-xl"
          >
